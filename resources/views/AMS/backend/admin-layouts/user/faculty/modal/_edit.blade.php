@if (Route::is('admin.user.account.faculty.index'))
    ...
    @else
        <div class="modal fade" id="edit{{ $facultyMem->id }}" tabindex="-1">
@endif
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            @else
                <form action="{{ route('admin.user.information.faculty.update', ['id' => $facultyMem->id]) }}"
                    method="POST">
                    <div class="modal-body">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" id="submit-save-faculty" class="btn btn-primary">Save
                                Changes</button>
                        </div>
                </form>
            @endif
